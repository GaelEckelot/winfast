    ...
    ledger: [
      {
        ...
        role: "expenses",
        rows: [
          { id: "r1", label: "Tel", amount: 180 },
          { id: "r2", label: "Essence", amount: 1200 },
          { id: "r3", label: "Alimentation", amount: 6500 },
          { id: "r4", label: "Imprévu", amount: 3000 },
          { id: "r5", label: "Frais banque", amount: 150 },
          { id: "r6", label: "Entretien voiture", amount: 1000 },
          { id: "r7", label: "Loyer", amount: 12000 },
          { id: "r8", label: "Claude (janvier)", amount: 220 },
          { id: "r9", label: "Assurance Voiture (Mars)", amount: 400 },
          { id: "r10", label: "Impôts Avril (payé Sept ?)", amount: 1000 },
          { id: "r11", label: "Anniv M & P (mai & oct)", amount: 300 },
          { id: "r12", label: "gp.com (1er juin)", amount: 20 },
          { id: "r13", label: "Contrôle technique (27 juillet)", amount: 100 },
          { id: "r14", label: "CFE (05 novembre)", amount: 1000 },
          { id: "r15", label: "X (13 décembre)", amount: 120 },
          { id: "r16", label: "Cadeaux Noël", amount: 300 },
        ],
      },
      {
        id: "c2",
        ...
        role: "cashflow",
        rows: [
          { id: "r1", label: "Intérim 12", amount: 1500 },
          { id: "r2", label: "Perso cash", amount: 1700 },
          { id: "r3", label: "Perso épargne", amount: 6300 },
          { id: "r4", label: "Liquidité (100€)", amount: 35 },
          { id: "r5", label: "Business MRR", amount: 0 },
          { id: "r6", label: "Business cash", amount: 50 },
          { id: "r7", label: "Business épargne", amount: 0 },
        ],
      },
      {
        id: "c3",
        ...
        role: "assets",
        rows: [
          { id: "r1", label: "Crypto else", amount: 150 },
          { id: "r2", label: "BTC (100€)", amount: 80 },
          { id: "r3", label: "Stocks Tech", amount: 0 },
        ],
      },
      {
        id: "c4",
        ...
        role: "debts",
        rows: [
          { id: "r1", label: "Maman", amount: 5500 },
          { id: "r2", label: "Papa", amount: 4200 },
        ],
      },
      {
        id: "c5",
        ...
        role: "topay",
        rows: [
          { id: "r1", label: "Vie Juin", amount: 800 },
          { id: "r2", label: "Cadeau Ma", amount: 100 },
          { id: "r3", label: "Épargne pour paye mai" },
        ],
      },
      {
        id: "c6",
        ...
        role: "notes",
        rows: [
          { id: "r1", label: "6 mois savings = 15 k€ épargne que je touche pas" },
          { id: "r2", label: "Vie = 800 € => LE12 épargne 1 200€, reste is allouance" },
          { id: "r3", label: "Garde 1200€ sur perso cash" },
          { id: "r4", label: "700€ ARE en juillet sur juin" },
          { id: "r5", label: "Déménagement = 3000€" },
          { id: "r6", label: "Définir : 10 M de côté & 30 000€/mois en passif (from investmt)" },
          { id: "r7", label: "Dans quoi investir : s&p, nvidia… next pas early + invest stratégie" },
          { id: "r8", label: "Cold wallet Trezor Safe 5 + BTC % in invest & cashflow (long terme)" },
          { id: "r9", label: "Cadeau 12.09 : Trezor Safe 5 & massage SPA" },
          { id: "r10", label: "Exit dy @ 2k" },
          { id: "r11", label: "Ladder Million" },
          { id: "r12", label: "Chaque 25 du mois : BTC DCA 10 ; 20" },
        ],
      },
    ],
  },
